...
for %%F in ("src\App.jsx" "src\urlEncoding.js" "src\responseFormatting.js" "src\requestSettings.js" "src\requestHistory.js" "src\requestDiagnostics.js" "src\version.js" "vite.config.js" "package.json") do (
  if not exist "%%~F" (
